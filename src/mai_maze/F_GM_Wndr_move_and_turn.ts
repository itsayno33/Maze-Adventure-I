...
export function can_move_wndr(walk: I_WndrWalker, r: I_HopeAction): I_HopeResponceMove {
...
export function can_turn_wndr(walk: I_WndrWalker, r: I_HopeAction): I_HopeResponceTurn {
...
// 今は基本ダメージがゼロの設定
function _how_collide_wndr(walk: I_WndrWalker, r: I_HopeAction): _I_how_collide_wndr_rslt {
