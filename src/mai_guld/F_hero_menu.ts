...
export function hero_info_form_set(hres: C_Hero[], detail: T_Detail, idx: number):void {
    ...
    detail['hp']   .innerHTML = 'Ｈ　Ｐ: ' +  hero.abi_p_bsc?.['xp']?.toString() ?? '???';
    detail['mp']   .innerHTML = 'Ｍ　Ｐ: ' +  hero.abi_m_bsc?.['xp']?.toString() ?? '???';

    detail['atk_p']  .innerHTML = '攻撃力(物理): ' + hero.abi_p_bsc?.['atk']?.toString() ?? '???';
    detail['def_p']  .innerHTML = '防御力(物理): ' + hero.abi_p_bsc?.['def']?.toString() ?? '???';
    detail['quc_p']  .innerHTML = '俊敏力(物理): ' + hero.abi_p_bsc?.['quc']?.toString() ?? '???';
    detail['cnc_p']  .innerHTML = '目敏さ(物理): ' + hero.abi_p_bsc?.['cnc']?.toString() ?? '???';

    detail['str_p']  .innerHTML = 'ＳＴＲ(物理): ' + hero.abi_p_bsc?.['str']?.toString() ?? '???';
    detail['pwr_p']  .innerHTML = 'ＰＷＲ(物理): ' + hero.abi_p_bsc?.['pwr']?.toString() ?? '???';
    detail['vit_p']  .innerHTML = 'ＶＩＴ(物理): ' + hero.abi_p_bsc?.['vit']?.toString() ?? '???';
    detail['dex_p']  .innerHTML = 'ＤＥＸ(物理): ' + hero.abi_p_bsc?.['dex']?.toString() ?? '???';
    detail['agi_p']  .innerHTML = 'ＡＧＩ(物理): ' + hero.abi_p_bsc?.['agi']?.toString() ?? '???';
    detail['tec_p']  .innerHTML = 'ＴＥＣ(物理): ' + hero.abi_p_bsc?.['tec']?.toString() ?? '???';
    detail['luk_p']  .innerHTML = 'ＬＵＫ(物理): ' + hero.abi_p_bsc?.['luk']?.toString() ?? '???';
  
    detail['atk_m']  .innerHTML = '攻撃力(魔法): ' + hero.abi_m_bsc?.['atk']?.toString() ?? '???';
    detail['def_m']  .innerHTML = '防御力(魔法): ' + hero.abi_m_bsc?.['def']?.toString() ?? '???';
    detail['quc_m']  .innerHTML = '俊敏力(魔法): ' + hero.abi_m_bsc?.['quc']?.toString() ?? '???';
    detail['cnc_m']  .innerHTML = '目敏さ(魔法): ' + hero.abi_m_bsc?.['cnc']?.toString() ?? '???';

    detail['str_m']  .innerHTML = 'ＳＴＲ(魔法): ' + hero.abi_m_bsc?.['str']?.toString() ?? '???';
    detail['pwr_m']  .innerHTML = 'ＰＷＲ(魔法): ' + hero.abi_m_bsc?.['pwr']?.toString() ?? '???';
    detail['vit_m']  .innerHTML = 'ＶＩＴ(魔法): ' + hero.abi_m_bsc?.['vit']?.toString() ?? '???';
    detail['dex_m']  .innerHTML = 'ＤＥＸ(魔法): ' + hero.abi_m_bsc?.['dex']?.toString() ?? '???';
    detail['agi_m']  .innerHTML = 'ＡＧＩ(魔法): ' + hero.abi_m_bsc?.['agi']?.toString() ?? '???';
    detail['tec_m']  .innerHTML = 'ＴＥＣ(魔法): ' + hero.abi_m_bsc?.['tec']?.toString() ?? '???';
    detail['luk_m']  .innerHTML = 'ＬＵＫ(魔法): ' + hero.abi_m_bsc?.['luk']?.toString() ?? '???';
}
/*******
