...
export function hero_info_form_set(hres: C_Hero[], detail: T_Detail, idx: number):void {
    ...
    detail['hp']   .innerHTML = 'Ｈ　Ｐ: ' +  hero.abi_p?.bsc?.['xp']?.toString() ?? '???';
    detail['mp']   .innerHTML = 'Ｍ　Ｐ: ' +  hero.abi_m?.bsc?.['xp']?.toString() ?? '???';

    detail['atk_p']  .innerHTML = '攻撃力(物理): ' + hero.abi_p?.bsc?.['atk']?.toString() ?? '???';
    detail['def_p']  .innerHTML = '防御力(物理): ' + hero.abi_p?.bsc?.['def']?.toString() ?? '???';
    detail['quc_p']  .innerHTML = '俊敏力(物理): ' + hero.abi_p?.bsc?.['quc']?.toString() ?? '???';
    detail['cnc_p']  .innerHTML = '目敏さ(物理): ' + hero.abi_p?.bsc?.['cnc']?.toString() ?? '???';

    detail['str_p']  .innerHTML = 'ＳＴＲ(物理): ' + hero.abi_p?.bsc?.['str']?.toString() ?? '???';
    detail['pwr_p']  .innerHTML = 'ＰＷＲ(物理): ' + hero.abi_p?.bsc?.['pwr']?.toString() ?? '???';
    detail['vit_p']  .innerHTML = 'ＶＩＴ(物理): ' + hero.abi_p?.bsc?.['vit']?.toString() ?? '???';
    detail['dex_p']  .innerHTML = 'ＤＥＸ(物理): ' + hero.abi_p?.bsc?.['dex']?.toString() ?? '???';
    detail['agi_p']  .innerHTML = 'ＡＧＩ(物理): ' + hero.abi_p?.bsc?.['agi']?.toString() ?? '???';
    detail['tec_p']  .innerHTML = 'ＴＥＣ(物理): ' + hero.abi_p?.bsc?.['tec']?.toString() ?? '???';
    detail['luk_p']  .innerHTML = 'ＬＵＫ(物理): ' + hero.abi_p?.bsc?.['luk']?.toString() ?? '???';
  
    detail['atk_m']  .innerHTML = '攻撃力(魔法): ' + hero.abi_m?.bsc?.['atk']?.toString() ?? '???';
    detail['def_m']  .innerHTML = '防御力(魔法): ' + hero.abi_m?.bsc?.['def']?.toString() ?? '???';
    detail['quc_m']  .innerHTML = '俊敏力(魔法): ' + hero.abi_m?.bsc?.['quc']?.toString() ?? '???';
    detail['cnc_m']  .innerHTML = '目敏さ(魔法): ' + hero.abi_m?.bsc?.['cnc']?.toString() ?? '???';

    detail['str_m']  .innerHTML = 'ＳＴＲ(魔法): ' + hero.abi_m?.bsc?.['str']?.toString() ?? '???';
    detail['pwr_m']  .innerHTML = 'ＰＷＲ(魔法): ' + hero.abi_m?.bsc?.['pwr']?.toString() ?? '???';
    detail['vit_m']  .innerHTML = 'ＶＩＴ(魔法): ' + hero.abi_m?.bsc?.['vit']?.toString() ?? '???';
    detail['dex_m']  .innerHTML = 'ＤＥＸ(魔法): ' + hero.abi_m?.bsc?.['dex']?.toString() ?? '???';
    detail['agi_m']  .innerHTML = 'ＡＧＩ(魔法): ' + hero.abi_m?.bsc?.['agi']?.toString() ?? '???';
    detail['tec_m']  .innerHTML = 'ＴＥＣ(魔法): ' + hero.abi_m?.bsc?.['tec']?.toString() ?? '???';
    detail['luk_m']  .innerHTML = 'ＬＵＫ(魔法): ' + hero.abi_m?.bsc?.['luk']?.toString() ?? '???';
}
/*******
